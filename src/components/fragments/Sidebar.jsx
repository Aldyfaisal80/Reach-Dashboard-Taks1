...
export default function Sidebar() {
    return (
        <div className="fixed inset-y-0 left-0 z-30 w-64 bg-gray-900 lg:static lg:inset-0 flex flex-col">
            <div className="flex-shrink-0 mt-8 flex items-center justify-center">
                <div className="flex items-center">
                    <svg className="w-12 h-12" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            fill="#4C51BF" stroke="#4C51BF" strokeWidth="2" strokeLinecap="round"
